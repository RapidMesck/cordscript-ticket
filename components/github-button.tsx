export default function GithubButton() {
    return (
       <a href="https://github.com/RapidMesck/cordscript-ticket" target="_blank" rel="noopener noreferrer">
            <button
            ...
            >
                ...
                <span className="hidden md:inline">Made with ❤️ by RapidMesck</span>
            </button>
       </a> 
    )
}